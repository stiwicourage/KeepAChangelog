...
description: Use when writing or refactoring KeepAChangelog PowerShell code, which should always follow the maintainability guidelines.
---
...
- adding a new public command or private helper to KeepAChangelog
