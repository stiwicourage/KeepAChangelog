...
Canonical rule source for cross-cutting KeepAChangelog conventions that apply to every change. Topic-specific rules live in the other `.instructions.md` files; this file owns the rules that do not belong to one topic.
