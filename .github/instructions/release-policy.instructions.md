---
applyTo: "CHANGELOG.md,RELEASE_NOTE.md,project.json,.github/pull_request_template.md,src/public/*.ps1,tests/**/*Release*.ps1,tests/**/*Package*.ps1"
---
...
- Update command help in `docs/KeepAChangelog/en-US/` when public command behavior changes.
