# Review a KeepAChangelog change

> Invoke with `@.github/prompts/review-change.prompt.md`. Delegates to the `reviewer` agent.

Review a KeepAChangelog change set with emphasis on correctness, maintainability, validation, and workflow safety.
